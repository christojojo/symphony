    ...
    <div className="bg-ourServices">
      <div className="flex gap-[155px]">
        ...
        <div className="basis-[55%] py-[50px] flex flex-col justify-center">
          ...
          <h4 className="text-h4 leading-[65px] max-w-[418px] pb-[55px]">Wedding Decorations</h4>
          <ul className="*:text-26 *:leading-[28px] *:pb-[33px] *:text-ourSection pb-[30px]">
            <li><a href="#">Event Planner Sydney</a></li>
            <li><a href="#">Personalised Wedding Planning</a> </li>
            <li><a href="#">Budget Wedding Planning</a></li>
            <li><a href="#">Event Planner Sydney</a> </li>
          </ul>
          <div>
