      ...
      <div className="flex gap-[50px] md:gap-[50px] 3xl:gap-[155px] ">
        ...
        <div className="md:basis-full xl:basis-[55%] 3xl:basis-[55%] p-[80px] xl:py-[30px] xl:px-0 3xl:py-[100px] flex flex-col justify-center">
          <div className="md:text-center xl:text-left 3xl:text-left">
            ...
            <h4 className="text-h4 xl:text-45 2xl:text-h4 3xl:text-h4 leading-[55px] md:leading-[65px] 2xl:leading-[65px] 3xl:leading-[65px] max-w-[418px] pb-[30px] xl:pb-[30px] 2xl:pb-[55px] 3xl:pb-[55px] font-Cormorant md:mx-auto xl:mx-0">
              WEDDING DECORATIONS
            </h4>
            <ul className="evnt-planing *:text-22 2xl:*:text-26 3xl:*:text-26 *:leading-[28px] *:pb-[20px] xl:*:pb-[20px] 2xl:*:pb-[33px] 3xl:*:pb-[33px] *:text-ourSection pb-[30px] xl:pb-0 2xl:pb-[30px] 3xl:pb-[30px]">
              <li>
